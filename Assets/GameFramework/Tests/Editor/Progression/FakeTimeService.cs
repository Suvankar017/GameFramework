...
{
    /// <summary>Minimal controllable <see cref="ITimeService"/> for deterministic Progression
    /// tests - mirrors the same fake used by the Gameplay/Audio/Performance tests.</summary>
