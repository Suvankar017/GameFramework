...
{
    /// <summary>See <c>GameFramework.Quests.Tests.FakeTimeService</c>'s remarks - same pattern,
    ...
    /// GameFlowService's pause behavior depends on that being accurate.</summary>
